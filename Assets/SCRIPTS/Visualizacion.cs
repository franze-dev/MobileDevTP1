...
public class Visualizacion : MonoBehaviour
{
    ...
    public void SetLado(Lado lado)
    {
        ...
        //if (TechoRend == null)
        //{
        //    Debug.LogError("No se ha podido encontrar el renderer del techo del coche");
        //    return;
        //}

        //if (TechoRend.material == null)
        //{
        //    Debug.LogError("No se ha podido encontrar el material del renderer del techo del coche");
        //    return;
        //}

        //if (TechoRend.material.mainTexture == null)
        //{
        //    Debug.LogError("No se ha podido encontrar la textura del material del renderer del techo del coche");
        //    return;
        //}
